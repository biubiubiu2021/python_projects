...
class Window(QWidget):
    def __init__(self, vnc_windows):
        ...
        self.images = {}  # Store QLabel instances for images
        self.window_texts = {}  # Store window_text for each hwnd
        ...
        for window_text, (hwnd, _) in vnc_windows.items():
            ...
            image_label.setPixmap(take_screenshot(hwnd, window_text))
            v_layout.addWidget(image_label)

            self.images[hwnd] = image_label  # Store QLabel instance
            self.window_texts[hwnd] = window_text  # Store window_text
    ...
    def unlock(self, hwnd):
        ...
        # Take a new screenshot and update the QLabel instance
        window_text = self.window_texts[hwnd]  # Get the window_text for this hwnd
        pixmap = take_screenshot(hwnd, window_text)
        pixmap = pixmap.scaled(300, 100, Qt.KeepAspectRatio)
        self.images[hwnd].setPixmap(pixmap)
