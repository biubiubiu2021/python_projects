...
class Window(QWidget):
    def __init__(self, vnc_windows):
        super().__init__()
        self.setWindowTitle("Win_unlocker by_Caifu_v4.3")
        ...
        password_label = QLabel(f"Select the login account:", self)
        ...
        self.password_aaa = QRadioButton(username1, self)
        self.password_bbb = QRadioButton(username2, self)
        self.password_bbb.setChecked(True)
        self.password_ccc = QRadioButton(username3, self)
        ...
        # file_label = QLabel(f"Configuration File: {file_path}", self)
    ...
    def show_usage_info(self):
        ...
        dialog.setWindowTitle(f"Usage:  [ Account Configuration File: {file_path} ]")
