...
def login_to_windows(hwnd, username, password):
    ...
    # Clear the username field (assuming a maximum of 20 characters)
    for _ in range(20):
...
if 0 <= selection < len(vnc_windows):
    ...
    login_to_windows(selected_hwnd, "your_username", "Teawithrabbit@345678")
    time.sleep(2)
else:
