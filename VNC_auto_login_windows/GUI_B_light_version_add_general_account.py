...
import win32con
import sys
from PyQt5.QtWidgets import QApplication,QDesktopWidget, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QRadioButton, QButtonGroup, QScrollArea
...
class VNCWindows(QWidget):
    ...
    def unlock(self, hwnd):
        ...
        selected_username = "amr\\lab_raspdcg" if self.window.password_aaa.isChecked() else (
            "amr\\sys_paivauto" if self.window.password_bbb.isChecked() else ".\\general")
...
class Window(QWidget):
    def __init__(self, vnc_windows):
        super().__init__()
        self.setWindowTitle("VNC Unlocker by Caifu 20231124_v2")
