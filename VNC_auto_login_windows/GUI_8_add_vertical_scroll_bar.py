...
import sys
import io
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QRadioButton, QButtonGroup, QScrollArea
...
class VNCWindows(QWidget):
    def __init__(self, vnc_windows, window):
        ...
        self.window = window  # Add this line
    ...
    def unlock(self, hwnd):
        ...
        password = "Teawithrabbit@345678" if self.window.password_aaa.isChecked() else "Autoxpiv@1Autoxpiv@1"  # Change this line
...
class Window(QWidget):
    def __init__(self, vnc_windows):
        super().__init__()
        self.setWindowTitle("VNC Unlocker by Caifu 20231123_v1")
        ...
        self.scroll_area.setFixedHeight(500)  # Set the height of the scroll area
