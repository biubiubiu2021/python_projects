from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QLabel, QInputDialog,QMessageBox, QTextBrowser, QTextEdit, QCheckBox, QTableWidget, QTableWidgetItem, QHBoxLayout, QDialog
...
#Compare 2 kits
    ...
    def show_dialog(self):
        ...
        if sender == self.bt1:
            ...
            kitDetail = get_single_kit_info(text, self.platform)
            print("-=-=-=->",kitDetail)
    ...
    def compare_2kits(self):
        ...
        kitDict2 = get_single_kit_info(kitID2, self.platform)
        #kitDict1 = getKitDetails(kitID1)
        #kitDict2 = getKitDetails(kitID2)
        print("kit1--->", kitDict1)
        print("kit2--->", kitDict2)
    ...
    def details_5kits(self):
        ...
        kitDict1.update(get_single_kit_info(kits[0], self.platform))
        kitDict2.update(get_single_kit_info(kits[1], self.platform))
        kitDict3.update(get_single_kit_info(kits[2], self.platform))
        kitDict4.update(get_single_kit_info(kits[3], self.platform))
        kitDict5.update(get_single_kit_info(kits[4], self.platform))
